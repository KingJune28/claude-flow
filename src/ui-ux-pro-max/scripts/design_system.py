...
def format_master_md(design_system: dict) -> str:
    ...
    lines.append("}")
    lines.append(f".input:focus {{ border-color: {colors.get('primary', '#2563EB')}; outline: none; }}")
    lines.append("```")
    lines.append("")
...
def format_page_override_md(design_system: dict, page_name: str, page_query: str = None) -> str:
    ...
    for section, key in [("Layout Overrides", "layout"), ("Spacing Overrides", "spacing"),
        ...
        if data:
            ...
            lines.append("- No overrides — use Master")
        lines.append("")
...
def _generate_intelligent_overrides(page_name: str, page_query: str, design_system: dict) -> dict:
    ...
    if style_results:
        ...
        elif any(kw in keywords for kw in ["minimal", "simple", "clean"]):
...
def _detect_page_type(context: str, style_results: list) -> str:
    ...
    page_patterns = [
        ...
        (["pricing", "plans", "subscription"], "Pricing / Plans"),
